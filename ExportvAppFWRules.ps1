# Original script by: https://gist.github.com/davelee212
# Taken from: https://gist.github.com/davelee212/677791af2616532000477d07d69aa39e
#
...
foreach ($rule in $fwrules)foreach ($rule in $fwrules)
{
